...
def parse_opt():
    ...
    parser.add_argument('--save_checkpoint_every', type=int, default=2500,
                    help='how often to save a model checkpoint (in iterations)? 2500 for mscoco')
    parser.add_argument('--save_history_ckpt', type=int, default=0,
                    help='If save checkpoints at every save point')
    parser.add_argument('--checkpoint_path', type=str, default='log/cexe-sup-kl-w0-transf-coco-reproduce',
    ...
    # misc
    parser.add_argument('--id', type=str, default='cexe-sup-kl-w0-transf-coco-reproduce',
